...
class TestRecordUIResourceConfig(CCMMRecordsUIResourceConfig):
    template_folder = "templates"
    url_prefix = "/test_record"
    blueprint_name = "test_record_ui"
    model_name = "test_record"
    search_component = UIComponent(
        "Test_recordResultsListItem",
        "@js/test_record/search/ResultsListItem",
    ...
    application_id = "test_record"


class TestRecordUIResource(CCMMRecordsUIResource):
    pass

def ui_overrides(app):
    """Register UI overrides."""
    ui_resource_config = TestRecordUIResourceConfig()
...
def init_menu(app):
    ...
    with app.app_context():
        current_menu.submenu("plus.create_test_record").register(
...
def create_blueprint(app):
    ...
    blueprint = TestRecordUIResource(TestRecordUIResourceConfig()).as_blueprint()
    return blueprint
